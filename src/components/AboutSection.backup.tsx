        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Gopal Singh</span>. I build polished digital experiences using modern full-stack technologies, with a focus on clean interfaces, reliable systems, and thoughtful engineering.
            </motion.p>
          </motion.div>
          ...
          <div className="lg:col-span-5 flex items-center justify-center relative perspective-[1400px]">
            ...
            >
              ...
              <div className="md:ml-auto relative overflow-hidden w-full max-w-[390px] aspect-[4/5] bg-black rounded-sm">
                {/* Main Portrait */}
                <img
                  src={aboutImg}
                  alt="Gopal Singh"
